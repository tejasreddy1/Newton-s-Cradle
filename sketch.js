...
function setup() {
	...
	bobObject4 = new bob(420,575,40)
	bobObject5 = new bob(450,575,40)
	...
	rope4=new rope(bobObject4.body,roofObject.body,20, 0)
	rope5=new rope(bobObject5.body,roofObject.body,40, 0)
